...
module.exports = {
   ...
   theme: {
      extend: {
         ...
         backgroundImage: {
            "slider-1-desktop": "url('/images/slider-1-desktop.webp')",
            "slider-1-mobile": "url('/images/slider-1-mobile.webp')",
            "slider-2-desktop": "url('/images/slider-2-desktop.webp')",
            "slider-2-mobile": "url('/images/slider-2-mobile.webp')",
            "slider-3-desktop": "url('/images/slider-3-desktop.webp')",
            "slider-3-mobile": "url('/images/slider-3-mobile.webp')",
            "introduction-mobile": "url('/images/Introduction-mobile.webp')",
            "introduction-desktop": "url('/images/Introduction-desktop.webp')",
            "footer-mobile": "url('/images/footer-mobile.webp')",
            "footer-desktop": "url('/images/footer-desktop.webp')",
         },
      },
   },
   plugins: [],
